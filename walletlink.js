...
const preact_1 = __webpack_require__(/*! preact */ "hh2p");
...
const preact_1 = __webpack_require__(/*! preact */ "hh2p");
const hooks_1 = __webpack_require__(/*! preact/hooks */ "J5ZA");
...
const clsx_1 = __importDefault(__webpack_require__(/*! clsx */ "iuhU"));
const TryExtensionLinkDialog_css_1 = __importDefault(__webpack_require__(/*! ./TryExtensionLinkDialog-css */ "853V"));
const link_icon_svg_1 = __importDefault(__webpack_require__(/*! ./icons/link-icon-svg */ "C4r1"));
const globe_icon_svg_1 = __importDefault(__webpack_require__(/*! ./icons/globe-icon-svg */ "YQXw"));
const lock_icon_svg_1 = __importDefault(__webpack_require__(/*! ./icons/lock-icon-svg */ "WCWn"));
const QRLogo_1 = __importDefault(__webpack_require__(/*! ./icons/QRLogo */ "Clep"));
const preact_1 = __webpack_require__(/*! preact */ "hh2p");
const hooks_1 = __webpack_require__(/*! preact/hooks */ "J5ZA");
const QRCode_1 = __webpack_require__(/*! ./QRCode */ "LMR0");
const Spinner_1 = __webpack_require__(/*! ./Spinner */ "/1Jb");
...
const PollingBlockTracker = __webpack_require__(/*! eth-block-tracker */ "V5x4");
...
const WalletLinkUI_1 = __webpack_require__(/*! ./WalletLinkUI */ "16RA");
...
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "hh2p");
...
const createKeccakHash = __webpack_require__(/*! keccak/js */ "aYMp")
...
const operators_1 = __webpack_require__(/*! rxjs/operators */ "kU1M");
const TryExtensionLinkDialog_1 = __webpack_require__(/*! ./TryExtensionLinkDialog */ "1vXP");
class LinkFlow {
    constructor(options) {
...
const WalletLinkProvider_1 = __webpack_require__(/*! ./provider/WalletLinkProvider */ "e7sy");
const WalletLinkSdkUI_1 = __webpack_require__(/*! ./provider/WalletLinkSdkUI */ "G0Bx");
const WalletLinkRelay_1 = __webpack_require__(/*! ./relay/WalletLinkRelay */ "ZmYy");
const WalletLinkRelayEventManager_1 = __webpack_require__(/*! ./relay/WalletLinkRelayEventManager */ "UUbE");
const util_1 = __webpack_require__(/*! ./util */ "oK5k");
...
const operators_1 = __webpack_require__(/*! rxjs/operators */ "kU1M");
const util_1 = __webpack_require__(/*! ../util */ "oK5k");
const js_sha256_1 = __webpack_require__(/*! js-sha256 */ "bCcq");
...
const WalletLinkRelayAbstract_1 = __webpack_require__(/*! ./WalletLinkRelayAbstract */ "4W9J");
...
const SubscriptionManager_1 = __webpack_require__(/*! ./SubscriptionManager */ "4Uva");
...
/*!**********************************************!*\
  ...
  \**********************************************/
/*! exports provided: _args, _from, _id, _inBundle, _integrity, _location, _phantomChildren, _requested, _requiredBy, _resolved, _spec, _where, author, bugs, dependencies, description, devDependencies, engines, homepage, keywords, license, main, name, repository, scripts, types, version, default */
/***/ (function(module) {

module.exports = JSON.parse("{\"_args\":[[\"walletlink@2.1.8\",\"/home/user/provable/astrodrop-eth/astrodrop-frontend\"]],\"_from\":\"walletlink@2.1.8\",\"_id\":\"walletlink@2.1.8\",\"_inBundle\":false,\"_integrity\":\"sha512-rIjQ0EE1tywiaaSwVF/RGChuYM9v6DQjoBwP4kPYWAxRCtBiOBlorVma/6pM0IOiybZEJvAVLtq1wJ78V7HBxw==\",\"_location\":\"/walletlink\",\"_phantomChildren\":{\"base64-js\":\"1.5.1\",\"ieee754\":\"1.2.1\",\"inherits\":\"2.0.4\",\"is-arguments\":\"1.1.0\",\"is-generator-function\":\"1.0.10\",\"is-typed-array\":\"1.1.7\",\"safe-buffer\":\"5.1.2\",\"string_decoder\":\"1.1.1\",\"util-deprecate\":\"1.0.2\",\"which-typed-array\":\"1.1.6\"},\"_requested\":{\"type\":\"version\",\"registry\":true,\"raw\":\"walletlink@2.1.8\",\"name\":\"walletlink\",\"escapedName\":\"walletlink\",\"rawSpec\":\"2.1.8\",\"saveSpec\":null,\"fetchSpec\":\"2.1.8\"},\"_requiredBy\":[\"/bnc-onboard\"],\"_resolved\":\"https://registry.npmjs.org/walletlink/-/walletlink-2.1.8.tgz\",\"_spec\":\"2.1.8\",\"_where\":\"/home/user/provable/astrodrop-eth/astrodrop-frontend\",\"author\":{\"name\":\"Coinbase, Inc.\"},\"bugs\":{\"url\":\"https://github.com/walletlink/walletlink/issues\"},\"dependencies\":{\"@metamask/safe-event-emitter\":\"2.0.0\",\"bind-decorator\":\"^1.0.11\",\"bn.js\":\"^5.1.1\",\"buffer\":\"^6.0.3\",\"clsx\":\"^1.1.0\",\"eth-block-tracker\":\"4.4.3\",\"eth-json-rpc-filters\":\"4.2.2\",\"eth-rpc-errors\":\"4.0.2\",\"js-sha256\":\"0.9.0\",\"json-rpc-engine\":\"6.1.0\",\"keccak\":\"^3.0.1\",\"preact\":\"^10.5.9\",\"rxjs\":\"^6.6.3\",\"stream-browserify\":\"^3.0.0\",\"util\":\"^0.12.4\"},\"description\":\"WalletLink JavaScript SDK\",\"devDependencies\":{\"@types/bn.js\":\"^4.11.6\",\"@types/node\":\"^14.14.20\",\"browserify\":\"17.0.0\",\"copy-webpack-plugin\":\"^6.4.1\",\"core-js\":\"^3.8.2\",\"jasmine\":\"3.8.0\",\"karma\":\"^6.3.2\",\"karma-browserify\":\"8.1.0\",\"karma-chrome-launcher\":\"^3.1.0\",\"karma-jasmine\":\"^4.0.1\",\"nodemon\":\"^2.0.6\",\"raw-loader\":\"^4.0.2\",\"regenerator-runtime\":\"^0.13.7\",\"rxjs-tslint\":\"^0.1.7\",\"sass\":\"^1.32.0\",\"svgo\":\"^1.3.2\",\"ts-jest\":\"^26.4.4\",\"ts-loader\":\"^8.0.13\",\"tslib\":\"^2.0.3\",\"tslint\":\"^6.1.3\",\"tslint-config-prettier\":\"^1.18.0\",\"tslint-config-security\":\"^1.16.0\",\"tslint-microsoft-contrib\":\"^6.2.0\",\"typescript\":\"^4.1.3\",\"watchify\":\"4.0.0\",\"webpack\":\"^5.49.0\",\"webpack-cli\":\"^3.3.12\",\"whatwg-fetch\":\"^3.5.0\"},\"engines\":{\"node\":\">= 10.0.0\"},\"homepage\":\"https://github.com/walletlink/walletlink#readme\",\"keywords\":[\"cipher\",\"cipherbrowser\",\"coinbase\",\"coinbasewallet\",\"eth\",\"ether\",\"ethereum\",\"etherium\",\"injection\",\"toshi\",\"wallet\",\"walletlink\",\"web3\"],\"license\":\"Apache-2.0\",\"main\":\"dist/index.js\",\"name\":\"walletlink\",\"repository\":{\"type\":\"git\",\"url\":\"git+https://github.com/walletlink/walletlink.git\"},\"scripts\":{\"build\":\"node compile-assets.js && webpack --config webpack.config.js\",\"build-chrome\":\"webpack --config webpack.config.chrome.js\",\"build-npm\":\"tsc -p ./tsconfig.build.json\",\"build:dev\":\"export WALLETLINK_URL='http://localhost:3000'; yarn build && yarn build-chrome\",\"build:dev:watch\":\"nodemon -e 'ts,tsx,js,json,css,scss,svg' --ignore 'src/**/*-css.ts' --ignore 'src/**/*-svg.ts' --watch src/ --watch chrome/ --exec 'yarn build:dev'\",\"build:prod\":\"yarn build && yarn build-chrome && yarn build-npm && cp ./package.json ../README.md ../LICENSE build/npm && cp -a src/vendor-js build/npm/dist && sed -i.bak 's|  \\\"private\\\": true,||g' build/npm/package.json && rm -f build/npm/package.json.bak\",\"lint\":\"tslint -p . 'src/**/*.ts{,x}'\",\"lint:watch\":\"nodemon -e ts,tsx,js,json,css,scss,svg --watch src/ --exec 'yarn tsc && yarn lint'\",\"test\":\"yarn build-npm && karma start\",\"tsc\":\"tsc --noEmit --pretty\"},\"types\":\"dist/index.d.ts\",\"version\":\"2.1.8\"}");
