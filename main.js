...
module.exports = __webpack_require__(/*! /home/user/provable/astrodrop-eth/astrodrop-frontend/src/main.ts */"zUnb");
...
IPFS.prototype.stat = function cat(ipfsHash, callback) {
  var self = this;
  self.sendAsync({ jsonParse: true, uri: '/object/stat?arg=' + ipfsHash }, callback);
};
...
IPFS.prototype.cat = function cat(ipfsHash, callback) {
  var self = this;
  self.sendAsync({ uri: '/cat?arg=' + ipfsHash }, callback);
};
...
class Web3Enabled {
    constructor(web3) {
        ...
        this.infuraKey = 'eba20d0db2cd4fceaa6d08694a4e1254';
